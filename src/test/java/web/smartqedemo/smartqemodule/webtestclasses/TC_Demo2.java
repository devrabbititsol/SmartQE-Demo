...
public class TC_Demo2 extends BaseClass {
	...
	public TC_Demo2() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_Demo2.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("tc_demo2.properties");
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, DemoScreen.projectName);
		test = reports.startTest("TC_Demo2");
	}
